package com.zking.ssm.util.faces;
...
public class FaceSpot {
    ...
    //需要修改为自己的
    private static final String AppID = "18014963";
    private static final String APIKey = "WWSgSK9mHDc4ffs9c98CfCth";
    private static final String SecretKey = "KahdPyswewOOcIGQfcGauhpynXXrwaN9";
